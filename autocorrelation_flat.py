...
df = pd.read_csv("/Network/Servers/vimes.astro.wesleyan.edu/Volumes/users/anederlander/Desktop/hd206893_research/flat_combined_2000.csv")
...
plt.savefig("autocor_flatdisk.pdf")
